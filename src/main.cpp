...
void oledType(){
  ...
  oledTick=millis();String title=singMode?"SINGING":"SPEAKING";
...
bool initMic(){
  ...
  i2s_pin_config_t p={
    I2S_PIN_NO_CHANGE,BCLK,WS,I2S_PIN_NO_CHANGE,SD
  };
...
void answer(const String&q){
  ...
  /* SEMUA PERINTAH LAIN WAJIB MEMANGGIL TARS */
  if(!calledTARS(q)){
