...
void testDAC(){
  Serial.println("TARS: DAC 1KHZ TEST START");
  ...
  for(int i=0;i<samples;i++){
    ...
    uint8_t u=(uint8_t)(128.0f+90.0f*s);
  ...
  Serial.println("TARS: DAC 1KHZ TEST DONE");
}
...
void setup(){
  ...
  if(wifiOK()){
    ...
    // Tes DAC setelah WiFi selesai dikonfigurasi
    if(dacOK)
      testDAC();
  }
