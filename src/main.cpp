// Complete main.cpp — persistent A2DP instance, safe callbacks, full original logic with fixes.
...
// ============================================================
// OLED FUNCTIONS (kept same as original)
// ============================================================
...
// ============================================================
// NETWORK / TTS / NTP / WiFi (identical to original)
// ============================================================
...
// ============================================================
// RELEASE / START BLUETOOTH (reuse persistent object)
// ============================================================
bool startBluetooth() {
    ...
    if (a2dpSource == nullptr) {
        ...
        // register safe callbacks initially (data noop until start)
    ...
    // before starting, ensure real data callback is set
    ...
    if (!btConnected) {
        ...
        printHeap("BT_FAILED");
        // set noop and stop but keep object
        a2dpSource->set_data_callback(getAudioDataNoop);
...
bool playMP3() {
    ...
    // BLUETOOTH FULL RELEASE (stop but keep object)
    stopBluetooth();
    // AUDIO SESSION CLEANUP
    cleanupAudioSession();
    playbackRunning = false;
