  ...
  /*
    MP3:
      MeloTTS
        ...
        -> MP3DecoderHelix
        -> PCM actual format
        -> AnalogAudioStream stereo
        -> GPIO25 LEFT
        -> GPIO26 RIGHT

    Tidak ada converter mono->stereo.
  */
...
void setup(){
  ...
  /*
    AudioTools diagnostic logging.
    INFO dipakai sementara untuk mengetahui:
    sample rate / channels / bits / decoder / DAC
    dan perubahan AudioInfo dari MP3.
  */
